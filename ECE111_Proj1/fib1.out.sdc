## Generated SDC file "fib1.out.sdc"
...
create_clock -name {clk} -period 1.960 -waveform { 0.000 0.980 } [get_ports { clk }]
create_clock -name {reset_n} -period 1.960 -waveform { 0.000 0.980 } [get_ports { reset_n }]
